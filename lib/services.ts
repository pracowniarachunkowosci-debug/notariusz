export type Service = { id: string; title: string; category: string; keywords: string[]; description: string };

export const services: Service[] = [
  { id: "sprzedaz-mieszkania", title: "Sprzedaż mieszkania", category: "Nieruchomości", keywords: ["sprzedaję mieszkanie", "lokal", "dom", "sprzedaż"], description: "Sprawdź, jak przygotować dokumenty do umowy sprzedaży." },
  ...
  { id: "spolka-zoo", title: "Założenie spółki z o.o.", category: "Spółki i biznes", keywords: ["chcę założyć spółkę", "firma", "biznes", "spółka"], description: "Sprawdź, jak wygląda założenie spółki z ograniczoną odpowiedzialnością." },
  ...
  { id: "akt-poswiadczenia-dziedziczenia", title: "Akt poświadczenia dziedziczenia", category: "Spadki", keywords: ["spadek", "dziedziczenie", "muszę załatwić spadek"], description: "Sprawdź, kiedy można potwierdzić prawa do spadku u notariusza." },
  ...
  { id: "najem-okazjonalny", title: "Najem okazjonalny", category: "Nieruchomości", keywords: ["mieszkanie", "wynajem", "najem"], description: "Przygotuj umowę najmu okazjonalnego i wymagane oświadczenia." },
