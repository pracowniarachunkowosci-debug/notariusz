...
export const metadata: Metadata = {
  ...
  alternates: { canonical: absoluteSiteUrl("/nieruchomosci/sprzedaz-mieszkania/") },
  openGraph: { title: "Sprzedaż mieszkania u notariusza | Wrocław", description: "Dokumenty, hipoteka, spadek lub darowizna, świadectwo energetyczne i przebieg sprzedaży mieszkania u notariusza.", type: "article", url: absoluteSiteUrl("/nieruchomosci/sprzedaz-mieszkania/") },
};

function ApartmentStructuredData() {
  const breadcrumb = apartmentSaleData.breadcrumb.map((item, index) => ({ "@type": "ListItem", position: index + 1, name: item.label, item: absoluteSiteUrl(item.href) }));
